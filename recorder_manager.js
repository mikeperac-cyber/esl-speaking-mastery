/**
 * ESL Speaking Audio Recorder & IndexedDB Storage System
 * Supports:
 * - MediaRecorder Audio Capture
 * - Web Speech Recognition (Live Speech-to-Text)
 * - IndexedDB Persistent Storage (survives page refresh & session changes)
 * - Audio Playback & File Download
 * - Live Speaking Analytics (Word Count, Speaking Duration, WPM)
 * - All Recordings Manager Modal
 */
  ...
  initDB() {
    return new Promise((resolve, reject) => {
      ...
      request.onerror = (event) => {
        ...
        resolve(null); // Fallback gracefully to in-memory
      };
    });
  }
